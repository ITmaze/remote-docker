...
- `docker.config`, the file that contains variables used throughout the code.
...
- `docker.config` is requried and is expected to be located with all the other scripts.
